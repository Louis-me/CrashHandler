...
//        System.exit(1);  
     ...
     * @throws Exception 
     */  
    private String savaInfoToSD(Context context, Throwable ex) throws Exception {  
...
//      Log.i("socket_client", str);
      String str_urlString = "http://192.168.1.38:8088/"+"devices="+Build.DEVICE.toString()+"&crashLog="+fileName.toString();
      new Thread(new Thread2(str_urlString)).start();
        return fileName;  
    }  
